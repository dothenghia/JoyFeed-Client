        ...
        <div className={`${open ? 'sidebar showSidebar' : 'sidebar'} flex w-[14rem] bg-white flex-col justify-between py-4 px-3 transition-all duration-700 ease-in-out`}
            ...
            <div>
                ...
                <div className="navbar-list">
                    ...
                    <Link to='/config' className={`navbar-item ${location.pathname === '/config' ? 'active' : ''}`}>
                    ...
                    <Link to='/history' className={`navbar-item ${location.pathname === '/history' ? 'active' : ''}`}>
            ...
            <div>
                <Link to='/setting' className={`navbar-item ${location.pathname === '/setting' ? 'active' : ''}`}>
